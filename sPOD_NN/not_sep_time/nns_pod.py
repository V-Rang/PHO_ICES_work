...
class NNsPOD:
    ...
    pass
    pass
    def __init__(self, snapshots: np.ndarray, coords: np.ndarray, ref_idx: int, eps_svd: float=0.001, eps_interp: float=1e-07, eps_shift: float=0.1, interp_lr: float=0.001, shift_lr: float=0.0001, interp_epochs: int=500, shift_epochs: int=500, batch_size: int=10, device: str=None):
