...
def rom_reconstruction_error(X_train: jnp.ndarray, Y_train: jnp.ndarray, phi_mat: jnp.ndarray, A_hat: jnp.array, A_tilde: jnp.ndarray, phi_bar_mat: jnp.ndarray, U_r: jnp.ndarray, library_functions: Sequence, indices) -> jnp.ndarray:
