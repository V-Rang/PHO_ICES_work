...
batch_size = 50
l_val = 30
seq_len = 10 # sequence length to train on 
pred_len = 10 # prediction length to predict, train on seq_len data and then do rolling forecast pred_len from each seq_len input.
decoder_net = (32, 32)
