...
import argparse
from utils.tools_1_normalized import make_library_functions, apply_selected_funcs
...
# print(lhs_mat.min(), lhs_mat.max()) # -0.00024414062 0.73759884
...
from models.models_1.model_cae_m1_normalized import (
    ConcreteAutoencoder,
    create_train_state,
    train_for_epochs,
)
