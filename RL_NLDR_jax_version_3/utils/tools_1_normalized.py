...
def make_rom_reconstruction_error(phi_mat, A_hat, A_tilde, U_l, min_tilde, max_tilde, library_functions):
    """
    ...
    def rom_reconstruction_error(X_batch_t, Y_batch_t, phi_bar, soft_selection):
        ...
        # jax.debug.print("{}", jnp.linalg.norm(Y_batch)) # 0.0


        # jax.debug.print("{}:{}", num, den) # 0.0:9.999999960041972e-13
