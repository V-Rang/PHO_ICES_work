...
def create_input(num_library_functions, num_library_functions_select, selection_length, sub_selection_length, trunc_svd_shape, num_samples_total, num_samples_each_batch):
    """
    Input:
    ...
    num_samples_total: Total number of samples to create for the Torch Dataset.
