...
X_hat = U_r.T @ X_train # (rval x k)

from models.models_2.model_gumbel import (
    ROMModel,
    create_train_state
)
...
# state, temperature_spatial, temperature_lib, train_loss_hist, val_loss_hist, mean_max_prob_spt, logit_vals_hist_spt, mean_max_prob_lib, logit_vals_hist_lib, best_train_loss, best_val_loss = train_for_epochs(
#     state = state,
#     X_hat = X_hat,
